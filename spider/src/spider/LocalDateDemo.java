...
public class LocalDateDemo {
	...
	public static void main(String[] args) {
		...
		Period age = Period.between(LocalDate.parse("1997-03-04"), LocalDate.now());
		System.out.println(age.getYears());
		
		LocalDate age2 = LocalDate.parse("1997-03-04").minus(LocalDate.now().getYear(), ChronoUnit.YEARS);
